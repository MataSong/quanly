...
const en: typeof zh = {
  common: {
    ...
    retry: "Retry",
    renderErrorTitle: "Failed to load page",
    actions: "Actions",
    status: "Status",
    name: "Name",
  ...
  strategy: {
    ...
    submitAuditConfirmPrivate: "This strategy is currently Private. Submitting for review will make it Public and list it in the marketplace, visible to all users once approved. This overrides your private setting. Confirm?",
    template: "Template",
    selectTemplate: "Select a built-in template",
    strategyName: "Strategy name",
    strategyDesc: "Description",
    visibility: "Visibility",
    sourceType: "Source",
    sourceUploaded: "Click-through template",
    sourceCode: "Python script",
    codeLabel: "Strategy code",
    codePlaceholder: "Write your on_tick(ctx, params) strategy function here",
    codeContract:
      "Contract: implement on_tick(ctx, params). ctx.candles(bar, limit) fetches candles; ctx.buy(sz)/ctx.sell(sz) place orders; ctx.log(level, msg) logs. Read inputs from params.",
    codeExample: "Insert example",
    codeRequired: "Strategy code is required",
    check: "Check",
    checking: "Checking…",
    checkStatus: "Check status",
    checkPassed: "Passed",
    checkFailed: "Failed",
    checkPending: "Pending check",
    checkStage: "Stage",
    checkStageSyntax: "Syntax check",
    checkStageAst: "Security audit",
    checkStageTrial: "Trial run",
    checkSyntaxError: "Syntax error",
    checkAstViolations: "Security violations",
    checkTrialError: "Trial run error",
    checkTrialOk: "Trial run passed",
    checkSignalCount: "Signals produced",
    checkLine: "line",
    checkNotPassedHint: "Check not passed; cannot submit for review",
    checkResultTitle: "Check result",
    sourceVisual: "Visual Builder",
    indMA: "MA",
    indEMA: "EMA",
    indRSI: "RSI",
    indMACD: "MACD",
    indPrice: "Price",
    indVolume: "Volume",
    opCrossAbove: "Cross above",
    opCrossBelow: "Cross below",
    opGt: "Greater than",
    opLt: "Less than",
    ...
    rightInd: "Indicator",
    constValue: "Value",
    macdFast: "Fast period",
    macdSlow: "Slow period",
    macdSignal: "Signal period",
    macdLine: "Line",
    macdLineMacd: "MACD line",
    macdLineSignal: "Signal line",
    takeProfitPct: "Take profit (%)",
    stopLossPct: "Stop loss (%)",
    orderSize: "Order size",
    riskTitle: "Take profit / Stop loss",
    riskHint: "Leave empty to disable",
    ...
    userCount: "Users",
    orderCount: "Orders",
    referenceBacktest: "Reference backtest",
    noPerformance: "No run data yet",
    visibilityOpt: {
      private: "Private",
      public: "Public",
    },
